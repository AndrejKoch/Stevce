    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title">Edit mosaic</h4>
            </div>
            <div class="card-body">
                <form action="{{ url('admin/mosaic', [$gallery->id]) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="col-md-4">
                    <button type="submit" class="btn btn-primary">Update mosaic image</button>
                    </div>
                </form>
            </div>
        </div>
